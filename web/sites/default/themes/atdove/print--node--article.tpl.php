    ...
    <div class="article-body-wrapper">
        ...
        <div class="print-site_name">
          ...
          <span>Published on: </span>
            <span class="day"><?php  echo date("j M Y", $node->created); ?> </span>
          <?php endif; ?>
        </div>

        <hr class="print-hr" />
        
        <?php //$cleanContent = preg_replace('/style[^>]*/', '', $content); ?>
        ...
        <?php if ($sourceurl_enabled): ?>
            <div class="print-source_url">
                <p><?php if (isset($node->nid)) {print theme('print_sourceurl', array('url' => $source_url, 'node' => $node, 'cid' => $cid));} ?><br />
            </div>
        <?php endif; ?>
