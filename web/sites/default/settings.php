...
/**
 * D8cache.
 * https://www.drupal.org/project/d8cache
 * A requirement of the Pantheon Advanced Page Cache module.
...
// Enable commerce test mode on all environments except production.
$conf['commerce_authnet_force_testmode'] = TRUE;
// Enable email rerouting on all environments except production.
$conf['reroute_email_enable'] = 1;
// Disable automatic cron on all environments except production.
// This is to reduce the number of emails going to the rerouted
// email address. As long as commerce test mode and email rerouting are enabled,
// it should be safe to enable cron temporarily for development/debugging.
// You can also manually trigger cron.
$conf['cron_safe_threshold'] = 0;
// Pantheon environments.
if (defined('PANTHEON_ENVIRONMENT')) {
  if (PANTHEON_ENVIRONMENT == 'live') {
    // Disable commerce test mode on production.
    $conf['commerce_authnet_force_testmode'] = FALSE;
    // Disable email rerouting on production.
    $conf['reroute_email_enable'] = 0;
    // Enable cron on production.
